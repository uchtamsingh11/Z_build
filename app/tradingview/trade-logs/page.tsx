...
import { History, TerminalIcon } from "lucide-react"
        ...
        <SidebarInset>
          ...
          <div className="space-y-10 relative z-10">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-sm font-mono uppercase tracking-wider text-white">TRADE_LOGS</h2>
            </div>
            
            <Card className="border-zinc-800 bg-zinc-900/50 shadow-md">
              <CardContent className="pt-6 space-y-6">
                {/* Content for Trade Logs page */}
              </CardContent>
            </Card>
          </div>
        </SidebarInset>
