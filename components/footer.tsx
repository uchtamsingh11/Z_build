    ...
    <footer className="relative border-t border-zinc-800 bg-black text-white font-mono">
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8 relative z-10">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm text-zinc-400 font-mono uppercase">
              <Link href="/privacy" className="block transition-colors hover:text-white min-h-10 py-2 flex items-center">
                PRIVACY_POLICY
              </Link>
              <Link href="/disclaimer" className="block transition-colors hover:text-white min-h-10 py-2 flex items-center">
                DISCLAIMER_POLICY
              </Link>
              <Link href="/terms" className="block transition-colors hover:text-white min-h-10 py-2 flex items-center">
                TERMS_AND_CONDITIONS
              </Link>
              <Link href="/cookies" className="block transition-colors hover:text-white min-h-10 py-2 flex items-center">
                COOKIES_POLICY
              </Link>
              <Link href="/refund" className="block transition-colors hover:text-white min-h-10 py-2 flex items-center">
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm text-zinc-400 font-mono uppercase">
              <a href="https://wa.me/919241740350" className="flex items-center gap-2 transition-colors hover:text-white min-h-10 py-2">
              ...
              <a href="https://t.me/AlgoZsupport1" className="flex items-center gap-2 transition-colors hover:text-white min-h-10 py-2">
              ...
              <a href="tel:+919241740350" className="flex items-center gap-2 transition-colors hover:text-white min-h-10 py-2">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-zinc-800 pt-8 text-center md:flex-row">
          ...
          <nav className="flex flex-wrap gap-4 text-sm sm:text-base text-zinc-400 font-mono uppercase">
            <Link href="/privacy" className="transition-colors hover:text-white min-h-10 py-2 px-2 flex items-center">
              PRIVACY_POLICY
            </Link>
            <Link href="/terms" className="transition-colors hover:text-white min-h-10 py-2 px-2 flex items-center">
              TERMS_OF_SERVICE
            </Link>
            <Link href="/cookies" className="transition-colors hover:text-white min-h-10 py-2 px-2 flex items-center">
              COOKIE_SETTINGS
            </Link>
          </nav>
        </div>
